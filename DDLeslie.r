...
ProjectHarvest_homo = function(Survival, Harvpar,Fec, SRB,E0=NULL, aK0 = NULL, global = F, null = F,bl , period, nage,Harv_assump){
  ...
  for(i in 1 : period + 1){
    Harvest[,i] = ProjectHarvest_helper(Harvest[,i-1],global = global, Leslie = Leslie, E0=E0, aK0=aK0, H_n=Harvpar[,i-1],H_np1 = Harvpar[,i],null = null,nage_female = nage[1]) # project harvest from very initial
  }              
  return(Harvest)
} #checked 10/24/2018
...
log.lhood =function(n.census, n.hat){
    ...
    density = dpois(x=n.census,
                     lambda = n.hat,
                     log = TRUE
                     ) # Use Poisson instead in Poisson_likelihood
