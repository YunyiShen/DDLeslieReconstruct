...
MSD = mean(apply(Chicago_RES$mcmc.objs$harvest.mcmc,2,sd))
SE_MSD = sd(apply(Chicago_RES$mcmc.objs$aerial.count.mcmc,2,sd))/sqrt(nrow(Chicago_RES$mcmc.objs$harvest.mcmc))
