...
# restart here 10/22/2018 20:45. Left arm is So0o0o0o0o painful after the flu shot!!!!! 
      ...
      #   ** Don't allow negative population
	        if(homo){
				full.proj =
				(ProjectHarvest_homo(Survival = invlogit(logit.curr.s), Harvpar = invlogit(logit.curr.H),Ferc=exp(log.curr.f), E0=E0, K0 = exp(log.curr.K0), global = global, null = null, bl = exp(log.prop.b) * invlogit(logit.curr.H) #<-- use proposal
